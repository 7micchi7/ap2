...
public class Kadai01_3 extends javax.swing.JFrame {
	...
	@SuppressWarnings("unchecked")
		...
		int str3 = Integer.parseInt(str2) + Integer.parseInt(jTextField3.getText());;


		jTextField3.setText(String.valueOf(str3));
		String str4 = String.valueOf(String.format("%.2f", (double)str3/addCount));
